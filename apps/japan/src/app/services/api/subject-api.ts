...
const subjectAPIService = {
    getSubjectsList: function (input: string,page : number) {
        ...
        const config = {
            method: 'get',
            url: 'https://test.cms.campaign.cactusops.com/api/subject-areas?filters[sa_one][machine_name][$eq]=' + input + '&filters[type][$eq]=SA2.0&pagination[page]='+page,
            headers: {
                Authorization:
    ...
    getServiceFeatures: function () {
        const config = {
            method: 'get',
            url: 'https://test.cms.campaign.cactusops.com/api/subject-areas?populate[2]=sa_one.sa_testimonials,sa_one_five.social_attributes,sa_one.journals,sa_one_five.editors&filters[machine_name][$eq]=chemistry',
            headers: {
                Authorization:
                    'Bearer ',
            },
