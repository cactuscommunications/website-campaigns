          ...
          <div className='max-w-[900px] mx-auto'>
            {!hideHeading &&
              <React.Fragment>
                ...
                <MarkDown data = {' を含む '}></MarkDown>
                  <MarkDown data={((searchTitle  && searchTitle.split('を含む')[1]) ? (searchTitle.split('を含む')[1]).split('分野')[0] : params?.heading) + '!!break!!分野 では以下の専門分野に対応しています。'}></MarkDown>
                </h2>
