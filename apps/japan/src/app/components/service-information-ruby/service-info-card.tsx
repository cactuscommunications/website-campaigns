    ...
    <div className="flex justify-between flex-wrap py-8 px-7 sm:px-2.5 sm:pb-5">
      ...
      <div className="text-right sm:text-center">
        <a href={card.pricing.ctaLink}>
          <div
            className="w-auto mx-auto bg-green-600 flex rounded-md justify-between md:w-full sm:w-full ng-star-inserted">
            ...
            <div className="flex justify-center items-center w-16 bg-green-700 flex-shrink-0 rounded-r-md sm:w-14 md:w-17.5">
              <div>
